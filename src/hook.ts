...
export default function useTreeChanges<T extends Data>(value: T) {
  ...
  if (previousIsEqual.current !== isEqual || !isEqual) {
    ...
    instance.current = treeChanges(previousValue.current || value, value);
  }
